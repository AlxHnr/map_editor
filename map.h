...
void draw_layer(const unsigned short current_layer, const new_camera *camera, SDL_Surface *dest_surface);

void draw_tile(const unsigned short current_layer, const unsigned short x, const unsigned short y, const unsigned short current_tile_x, const unsigned short current_tile_y);
